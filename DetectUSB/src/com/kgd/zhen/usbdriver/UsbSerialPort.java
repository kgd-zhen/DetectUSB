...
public interface UsbSerialPort {
     ...
     *
     * @param 波特�?baudRate baud rate as an integer, for example {@code 115200}.
     ...
     *数据准备�?     * @return the current state, or {@code false} if not supported.
     * @throws IOException if an error occurred during reading
     */
     ...
     *数据终端准备�?     * @return the current state, or {@code false} if not supported.
     * @throws IOException if an error occurred during reading
     */
